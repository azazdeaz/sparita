...
function Editor(model) {
	...
	var x, y, z, ediBoxes = [], boxSize = [100, 100, 100],
	camera, scene, renderer;

	this._renderW = 400;
	this._renderH = 300;

	camera = new THREE.Camera( 45, this._renderW / this._renderH, .1, 1000 );
...
var ediBox = new EdiBox(model.boxDiv, boxSize);
	...
	window.rrrrrr = function () {renderer.render( scene, camera );}
}
